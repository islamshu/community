            ...
            @can('setting')
                ...
                <li class="nav-item  ">
                    <a href="{{ route('bank_info') }}">
                        ...
                        <span
                            class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\BankInfo::where('status', 2)->count() }}</span>
                    </a>
                </li>
                <li class="nav-item  ">
                    <a href="{{ route('all_withdrow_request') }}">
                        ...
                        <span
                            class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\BlalnceRequest::where('status', 2)->count() }}</span>
                    </a>
                </li>
            @endcan
