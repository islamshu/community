                                ...
                                <form class="form" method="post"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mt-2">
                                                <label>الاسم  </label>
                                                <input type="string" value="{{ old('name') }}" name="name" class="form-control" required >
                                            </div>
                                            <div class="col-md-6 mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-2 site_url" @if(old('have_website') != 1 ) selected  style="display: none" @endif >
                                                ...
                                                <input type="url" name="site_url" value="{{ old('site_url') }}" id="site_url" class="form-control"  >
                                            </div>
                                            <div class="col-md-8">
                                                <label>مجالات المستخدم  </label>
                                                <textarea name="domains" required class="form-control" id="" cols="30" rows="10">{{ old('domains') }}</textarea>
                                            </div>
