                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModal">انشاء مطالبة جديدة</button>
                                {{-- @endcan --}}
                                            ...
                                            @foreach ($claims as $key => $item)
                                                <tr>
                                                    ...
                                                    <th>
                                                        ...
                                                        <a href="{{ route('viewPdf_claim', $item->id) }}"
                                                            class="btn btn-success"><i class="fa fa-print"></i></a>
                                                        <a href="{{ route('resend_mail', $item->id) }}"
                                                            class="btn btn-info">اعادة الارسال</a>
                                                        @can('destroy-claim')
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('claims.store') }}">
                                ...
                                <div class="form-group">
                                    <label for="currency_id" class="col-form-label">العملة :</label>
                                    <select name="currency_id" required class=" form-control " id="currency_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="payment_method" required class=" form-control " id="payment_id">
...
@section('script')
    ...
    <script>
        ...
        $('#currency_id').on('change', function() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('payment_with_curreany') }}',
                data: {
