              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      <img src="{{asset('uploads/'.get_general_value('image_front'))}}" width="200"  alt="branding logo">
                    </div>
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>{{ "Arabi Community "}}</span>
                  </h6>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-simple" method="post" action="{{ route('post_login_admin') }}" novalidate>
                        @csrf
