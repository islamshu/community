...
<div class="container">
    ...
    <div class="hgroup">
          ...
          <span class="raised">   نود اخبارك ان اشتراكك سوف ينتهي اليوم هل تود التجديد</span>
          <a href="{{ $link }}" class="button">انقر للتجديد</a>
      <br>
        <br>
